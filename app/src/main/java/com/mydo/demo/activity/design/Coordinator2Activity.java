...
import com.mydo.demo.databinding.ActivityCoordinator2Binding;
...
/**
 * 嵌套滚动布局
 * 技术点：Coordinator, Behivor, NetscrollView
 * @author: LiBing.
 * @date: 2017/10/26.
 * @version: V1.0.0.
 */
public class Coordinator2Activity extends DataBindingActivity<ActivityCoordinator2Binding> {
    ...
    public void initView() {
        mViewBinding.message.setText(DIALOGUE[0]);
    }
}
